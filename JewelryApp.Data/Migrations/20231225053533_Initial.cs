        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gram17 = table.Column<double>(type: "float", nullable: false),
                    Gram18 = table.Column<double>(type: "float", nullable: false),
                    Gram24 = table.Column<double>(type: "float", nullable: false),
                    Mazanneh = table.Column<double>(type: "float", nullable: false),
                    Mesghal = table.Column<double>(type: "float", nullable: false),
                    UsDollar = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategory_Users_ModifiedUserId",
                        column: x => x.ModifiedUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshToken_Users_ModifiedUserId",
                        column: x => x.ModifiedUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceItem_Users_ModifiedUserId",
                        column: x => x.ModifiedUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItem_ModifiedUserId",
                table: "InvoiceItem",
                column: "ModifiedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OldGold_InvoiceId",
                table: "OldGold",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_OldGold_ModifiedUserId",
                table: "OldGold",
                column: "ModifiedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategory_ModifiedUserId",
                table: "ProductCategory",
                column: "ModifiedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RefreshToken_ModifiedUserId",
                table: "RefreshToken",
                column: "ModifiedUserId");
