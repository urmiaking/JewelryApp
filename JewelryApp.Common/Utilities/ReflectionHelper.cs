...
public static class ReflectionHelper
{
    ...
    {
        return type is { IsValueType: true, IsPrimitive: false, Namespace: not null } && !type.Namespace.StartsWith("System", StringComparison.Ordinal);
    }

    public static bool IsCustomReferenceType(this Type type)
    {
        return type is { IsValueType: false, IsPrimitive: false, Namespace: not null } && !type.Namespace.StartsWith("System", StringComparison.Ordinal);
    }
}
